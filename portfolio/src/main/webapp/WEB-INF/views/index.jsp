...
<body>
	...
	<div id="hero" class="hero route bg-image"
		style="background-image: url(resources/img/hero-bg.jpg)">
	...
	<main id="main">
							...
							<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-7">
											<div class="about-info">
												<p>
													<span class="title-s">Name: </span> <span>Morgan
														Freeman</span>
												</p>
												<p>
													<span class="title-s">Profile: </span> <span>full
												...
												<p>
													<span class="title-s">Phone: </span> <span>(617)
														557-0089</span>
												</p>
											</div>
										</div>
								...
								<div class="col-md-6">
									<div class="about-me pt-4 pt-md-0">
										...
										<p class="lead">Curabitur non nulla sit amet nisl tempus
										...
										<p class="lead">Mauris blandit aliquet elit, eget
										...
										<p class="lead">Nulla porttitor accumsan tincidunt.
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="title-box text-center">
							...
							<p class="subtitle-a">Lorem ipsum, dolor sit amet consectetur
								adipisicing elit.</p>
					...
					<div class="col-md-4">
						<div class="service-box">
							...
							<div class="service-content">
								...
								<p class="s-description text-center">Lorem ipsum dolor sit
									amet consectetur adipisicing elit. Magni adipisci eaque autem
									fugiat! Quia, provident vitae! Magni tempora perferendis eum
									non provident.</p>
							</div>
						</div>
					</div>
		...
		<div class="section-counter paralax-mf bg-image"
			style="background-image: url(resources/img/counters-bg.jpg)">
				...
				<div class="row">
						...
						<div class="counter-box pt-4 pt-md-0">
							<div class="counter-ico">
								<span class="ico-circle"><i
									class="bi bi-journal-richtext"></i></span>
							</div>
							<div class="counter-num">
								<p data-purecounter-start="0" data-purecounter-end="25"
									data-purecounter-duration="1" class="counter purecounter"></p>
					...
					<div class="col-sm-3 col-lg-3">
						<div class="counter-box pt-4 pt-md-0">
							...
							<div class="counter-num">
								<p data-purecounter-start="0" data-purecounter-end="48"
									data-purecounter-duration="1" class="counter purecounter"></p>
		...
		<section id="work" class="portfolio-mf sect-pt4 route">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="work-box">
							<a href="resources/img/work-1.jpg" data-gallery="portfolioGallery"
							...
							<div class="work-content">
								<div class="row">
									<div class="col-sm-8">
										<h2 class="w-title">Dapao</h2>
										<div class="w-more">
											<span class="w-ctegory">Web Develop</span> / <span
												class="w-date">2023. 11. 24</span>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="w-like">
					...
					<div class="col-md-4">
						<div class="work-box">
							<a href="resources/img/work-2.jpg" data-gallery="portfolioGallery"
								class="portfolio-lightbox">
								<div class="work-img">
...
<!-- 					<div class="col-md-4"> -->
<!-- 						<div class="work-box"> -->
<!-- 							<a href="resources/img/work-3.jpg" data-gallery="portfolioGallery" -->
<!-- 								class="portfolio-lightbox"> -->
<!-- 								<div class="work-img"> -->
...
<!-- 					<div class="col-md-4"> -->
<!-- 						<div class="work-box"> -->
<!-- 							<a href="resources/img/work-4.jpg" data-gallery="portfolioGallery" -->
<!-- 								class="portfolio-lightbox"> -->
<!-- 								<div class="work-img"> -->
...
<!-- 					<div class="col-md-4"> -->
<!-- 						<div class="work-box"> -->
<!-- 							<a href="resources/img/work-5.jpg" data-gallery="portfolioGallery" -->
<!-- 								class="portfolio-lightbox"> -->
<!-- 								<div class="work-img"> -->
...
<!-- 					<div class="col-md-4"> -->
<!-- 						<div class="work-box"> -->
<!-- 							<a href="resources/img/work-6.jpg" data-gallery="portfolioGallery" -->
<!-- 								class="portfolio-lightbox"> -->
<!-- 								<div class="work-img"> -->
									...
									<div class="testimonial-box">
										<div class="author-test">
											<img src="resources/img/testimonial-2.jpg" alt=""
												class="rounded-circle b-shadow-a"> <span
												class="author">Xavi Alonso</span>
										</div>
										<div class="content-test">
											<p class="description lead">Curabitur arcu erat, accumsan
												id imperdiet et, porttitor at sem. Lorem ipsum dolor sit
									...
									<div class="testimonial-box">
										<div class="author-test">
											<img src="resources/img/testimonial-4.jpg" alt=""
												class="rounded-circle b-shadow-a"> <span
												class="author">Marta Socrate</span>
										</div>
										<div class="content-test">
											<p class="description lead">Curabitur arcu erat, accumsan
												id imperdiet et, porttitor at sem. Lorem ipsum dolor sit
				...
				<div class="row">
					<div class="col-md-4">
						<div class="card card-blog">
							<div class="card-img">
								<a href="blog-single.html"><img src="resources/img/post-1.jpg"
							...
							<div class="card-body">
								...
								<p class="card-description">Proin eget tortor risus.
									Pellentesque in ipsum id orci porta dapibus. Praesent sapien
									massa, convallis a pellentesque nec, egestas non nisi.</p>
							</div>
							<div class="card-footer">
								<div class="post-author">
									<a href="#"> <img src="resources/img/testimonial-2.jpg" alt=""
										class="avatar rounded-circle"> <span class="author">Morgan
											Freeman</span>
									</a>
								</div>
								<div class="post-date">
					...
					<div class="col-md-4">
						<div class="card card-blog">
							<div class="card-img">
								<a href="blog-single.html"><img src="resources/img/post-2.jpg"
									alt="" class="img-fluid"></a>
							</div>
							<div class="card-body">
								<div class="card-category-box">
					...
					<div class="col-md-4">
						<div class="card card-blog">
							<div class="card-img">
								<a href="blog-single.html"><img src="resources/img/post-3.jpg"
									alt="" class="img-fluid"></a>
							</div>
							<div class="card-body">
								<div class="card-category-box">
									...
									<div class="col-md-6">
										...
										<div class="more-info">
											<p class="lead">Lorem ipsum dolor sit amet consectetur
												adipisicing elit. Facilis dolorum dolorem soluta quidem
												expedita aperiam aliquid at. Totam magni ipsum suscipit
												amet? Autem nemo esse laboriosam ratione nobis mollitia
												inventore?</p>
											<ul class="list-ico">
												<li><span class="bi bi-geo-alt"></span> 329 WASHINGTON
													ST BOSTON, MA 02108</li>
